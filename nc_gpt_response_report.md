...
41 城市按 GHI rank − FDSI rank 排列。红色 = GHI 高估 (shift ≤ −5)，绿色 = GHI 低估 (shift ≥ +5)，灰色 = 偏移 < 5。香港 (−21)、青岛 (−18)、乌鲁木齐 (−17) 是最大的高辐照陷阱（注：早期文档误记乌鲁木齐为 −22，41城实际数据为 −17）；哈尔滨 (+16) 和长沙 (+20) 是最大的 GHI 低估城市。51.2% 城市偏移 ≥ 5 位。
